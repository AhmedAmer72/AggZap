...
const faqItems = [
  {
    question: 'What is AggZap?',
    answer: 'AggZap is a cross-chain DeFi adapter built on Polygon AggLayer. It allows you to deposit assets from any chain and earn yields across multiple networks without manual bridging.',
  },
  {
  ...
  {
    question: 'Is AggZap secure?',
    answer: 'Yes! AggZap leverages AggLayer\'s ZK-proof security model. All cross-chain transactions are cryptographically verified, and our smart contracts are audited by leading security firms.',
  },
  {
  ...
  },
  {
    ...
    answer: 'AggZap charges a small protocol fee (0.1%) on yields earned. There are no deposit or withdrawal fees. You only pay standard gas fees for transactions.',
  },
];
            ...
            <div className="max-w-7xl mx-auto">
              ...
              >
                ...
                <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                  Learn about the technology powering chainless DeFi and how AggZap simplifies cross-chain yield farming.
                </p>
              </motion.div>
            </div>
          </section>
