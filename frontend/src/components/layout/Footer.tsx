...
const socialLinks = [
  ...
  { name: 'Email', icon: Mail, href: 'mailto:hello@aggzap.io', color: 'hover:bg-pink-500/20 hover:text-pink-400' },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-400 mb-6 max-w-sm leading-relaxed">
                The Stripe for Cross-Chain DeFi. We make every Polygon chain feel like one big bank account.
              </p>
