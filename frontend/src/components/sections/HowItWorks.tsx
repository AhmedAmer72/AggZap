      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            How <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">AggZap</span> Works
          </h2>
          <p className="text-gray-400 max-w-2xl mx-auto text-lg">
            Traditional cross-chain yield farming takes 5 transactions across 30 minutes.
            <span className="text-white font-medium"> AggZap does it in one click.</span>
          </p>
        </motion.div>
          ...
          <div className="relative group">
            ...
            <div className="relative bg-gradient-to-b from-green-900/20 to-black/80 backdrop-blur-xl rounded-2xl p-8 border border-green-500/20 h-full">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-semibold text-green-400">The AggZap Way</h3>
                <motion.span
